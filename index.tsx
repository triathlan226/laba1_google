...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const prizeInput = document.getElementById('prize-input') as HTMLInputElement;
    const prizeList = document.getElementById('prize-list') as HTMLDivElement;
    const updatePrizesBtn = document.getElementById('update-prizes') as HTMLButtonElement;
    ...
    updatePrizesBtn.addEventListener('click', () => {
        ...
        cells.forEach(cell => {
            const reel = cell as HTMLElement;
            const parentCell = reel.parentElement as HTMLElement;
    ...
    const stopSpin = (finalResults: string[]) => {
